function scalo_plots_folder = create_scalo_plots_folder(session_name,event_name,parent_directory)
...
if exist(session_folder, 'dir')
    scalo_plots_folder = sprintf('%s_scaloplots_%s', session_name, event_name);
