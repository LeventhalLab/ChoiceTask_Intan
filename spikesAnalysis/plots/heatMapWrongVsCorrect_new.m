function [filteredUnitNames,eventHeatMaps,primaryEvents]=heatMapDiffBehaviors(regionUnits,params)
%% Heatmap of difference between BehaviorA and BehaviorB (zscoreA - zscoreB)
%% Sorting by primary event from BehaviorA
...
figFileName = fullfile(savePath, sprintf('%s_diffHeatmaps_%s_%s_%s.png',treatmentToProcess,behaviorA,behaviorB,region));
