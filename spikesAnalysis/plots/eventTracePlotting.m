...
controlColor = [0 0.447 0.741];
lesionColor  = [0.85 0.325 0.098];

sgtitle(t, { ...
    sprintf('Mean \\pm SEM | Behavior = %s | Region = %s', behaviorField, region), ...
    sprintf('\\color[rgb]{%.3f %.3f %.3f}Lesion \\color{black}vs \\color[rgb]{%.3f %.3f %.3f}Control', ...
        lesionColor, controlColor) ...
    }, ...
