function [filteredUnitNames,eventHeatMaps,primaryEvents,secondaryEvents]=heatMapWrongVsCorrect(regionUnits,params)
...
for t=1:length(params.treatmentToProcess)
    for b=1:length(behaviorFields)
        ...
        for u = 1:length(unitNames)
            ...
            if isfield(behavioralFeatures, behaviorA) && isfield
                behaviorA = behavioralFeatures.(behaviorA);  % Get the behavior structure
