...
behaviorA={'cuedleft','slowreaction'};
behaviorAname='Slow Reaction Left';
behaviorB={'cuedleft','slowmovement'};
behaviorBname='Slow Movement left';
behaviorC={'cuedleft','moveright'};
behaviorCname='Cued Left-wrong Direction';
...
outputTitle='Cued Left Difficulty';
