function sessionSummary = CreateRatRTSummary(~, implantSide, varargin)
%
...
topLevelDir = '\\corexfs.med.umich.edu\sharedx\Neuro-Leventhal\data\ChoiceTask';
...
% elseif ispc
%     % figure out the IP address for the data are stored
