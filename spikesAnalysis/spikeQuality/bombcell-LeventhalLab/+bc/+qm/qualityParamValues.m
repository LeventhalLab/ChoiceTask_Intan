...
param.hillOrLlobetMethod = 0; % 1 to use Hill et al method; 0 to use Llobet et al method
...
param.minSpatialDecaySlopeExp = 0.001; % in a.u./um
...
param.minNumSpikes = 6000; % number of spikes
