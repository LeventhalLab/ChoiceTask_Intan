...
specifyRegions = 1;
ignoreNotDirectionallySelective=1;
treatments = {'control'};
...
for i = 1:length(regionsAvailable)
    ...
    for b = 1:length(behaviors)
                        ...
                        for s = 1:length(sessions)
                            ...
                            for u = 1:length(units)
                                ...
                                if ignoreNotDirectionallySelective && ...
                                   ismember(sessionData.units.(uid).noseOutResponsiveness, ...
                                            {'NotDirectionallySelective','undeterminable','ipsilateral'})
                                    continue
                                end
        ...
        exportgraphics(gcf, ...
            ...
            [region '_' behavior '_FRvsRTMT_Zscore.png']), ...
            'Resolution',300);
