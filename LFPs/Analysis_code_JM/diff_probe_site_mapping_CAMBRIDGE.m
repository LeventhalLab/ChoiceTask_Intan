function diff_lfps = diff_probe_site_mapping_CAMBRIDGE(lfp_data, probe_type)
...
% lfp_data = load('R0427_WatsonRig_20220909_monopolarpower.mat'); % Line required if running the code individually for troubleshooting purposes
