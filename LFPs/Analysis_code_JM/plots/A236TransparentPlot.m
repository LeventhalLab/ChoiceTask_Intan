...
% but its just the 7 ASSY236 probe rats
...
% its all alone
excludeRatIDs = {'R0376', 'R0374', 'R0396', 'R0413', 'R0419', 'R0326', 'R0327', 'R0372', 'R0378', 'R0379', 'R0349', 'R0395','R0419'};
...
title(t,'3D Scatter Plot of Midpoint Coordinates ASSY236 only (transparency = power)');
%outdated legend
...
% savefig('X:\Neuro-Leventhal\data\ChoiceTask\voxel power\236TransparentPlot.fig')
