    ...
    for i_session = 1 : num_sessions
        ...
        for i_lfptype = 1 : length(lfp_types)
            ...
            for i_event = 1 : length(event_list)
                ...
                trial_feature = 'all';
                scalo_power_fig_name = sprintf('%s_scalopower_%s_%s_%s', session_name, lfp_type, trial_feature, event_name);
                scalo_power_fig_name = fullfile(scalo_plots_folder, scalo_power_fig_name);

                scalo_mrl_fig_name = sprintf('%s_scalomrl_%s_%s_%s', session_name, lfp_type, trial_feature, event_name);
                scalo_mrl_fig_name = fullfile(scalo_plots_folder, scalo_power_fig_name);
                if exist(scalo_power_fig_name, 'file') && exist(scalo_mrl_fig_name)
                    continue
                end
                ...
                print(geometry_power_fig, scalo_power_fig_name, '-dpdf')
