                    ...
                    for i_shankcol = 1 : cols_per_shank
                        for i_site = 1 : n_rows
                            ...
                            trials_during_disconnects = find_trials_during_disconnects(session_qc_check, ...
                                session_name, ...
                                scalo_data.trials(scalo_data.target_trials), ...
                                event_list{i_event}, ...
                                scalo_data.t_window);

                            % todo: eliminate scalograms with artifacts

                            valid_scalos = scalo_data.event_related_scalos(~trials_during_disconnects, :, :);
