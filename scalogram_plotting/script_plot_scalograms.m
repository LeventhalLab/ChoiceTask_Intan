    ...
    for i_session = 1 : num_sessions
        ...
        for i_lfptype = 1 : length(lfp_types)
            ...
            for i_event = 1 : length(event_list)
                ...
                test_scalo_name = sprintf('%s_scalos_%s_%s_shank%02d_site%02d.mat',session_name, lfp_type, event_name, 1, 1);
                ...
                header_string = sprintf('%s lfp power, %s, %s trials, %s, total n=%d', lfp_type, session_name, trial_feature, event_name, n_trials);
