...
%         [ordered_lfp, intan_site_order, intan_site_order_for_trials_struct, site_order] = lfp_by_probe_site_ALL(lfp_data, probe_type);
    ...
    %             scalo_folder = fullfile(cur_dir, scalo_folder);
                ...
                for i_channel = 1 : n_channels
                    ...
                    ERP_name = sprintf('%s_ERPs_%s_%s_shank%02d_site%02d.mat',session_name, lfp_type, event_name, shank_num, site_num);
                    ...
                    save(ERP_name, 'event_related_scalos', 'event_triggered_lfps', 'fb', 'coi', 't_window', 'i_channel', 'trials');
