function trials = createTrialsStruct_simpleChoice_Intan( logData, nexData )
%
% usage:
%
% INPUTS:
...
%   nexData - nex data structure created by intan2nex
%
% OUTPUTS:
...
GO_markStartIdx = getEventIdx( events, 'gotrialon');   % index of GO trial marker on events
GO_markEndIdx   = getEventIdx( events, 'gotrialoff');  % index of GO trial marker off events

GO_markEnd_ts   = events{GO_markEndIdx}.timestamps(1:end);
